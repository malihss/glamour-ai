    ...
    <div className="pt-[88px]">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-12">
            ...
            {product.avgRating != null && (
              <div className="flex items-center gap-3 mb-6">
                <div className="flex gap-1">
                  {stars.map(s => (
                    <Star key={s} size={14}
                      className={s <= Math.round(product.avgRating) ? 'fill-champagne text-champagne' : 'text-champagne/20'} />
                  ))}
                </div>
        ...
        {product.reviews?.length > 0 && (
          <div className="mb-20">
            <h2 className="font-display text-3xl text-noir mb-8">Customer Reviews</h2>
